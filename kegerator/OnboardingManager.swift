...
class OnboardingManager {
    ...
    private func configuredWelcomeScreenStep() -> WelcomeScreenStep {
        let discoveryConfigurationTransformer = DiscoveryServiceConfigurationTransformer(applicationID: "kegerator", authenticationPath: "kegerator")
        ...
        welcomeScreen.welcomeScreenCustomizationHandler = { welcomeScreen in
            welcomeScreen.headlineLabel.text = "kegerator"
